...
const Navbar = () => {
  ...
  return (
    ...
    <div className='flex items-center mt-[-20px] justify-between py-1'>
      <Link to='/'>
      ...
      <div>
        {user ?
          ...
          <div className='flex items-center gap-2 sm:gap-5'>
            ...
            <button onClick={()=>setShowLogin(true)} className='bg-[#8C1C13] text-white px-7 py-2 sm:px-10 text-sm rounded-full'>Login</button>
          </div>
        }
      </div>
